...
type CurrentSate = { success: boolean; error: boolean };
...
export const deleteTeacher = async (
  ...
  try {
    ...
    await prisma.teacher.delete({
      where: {
        id: id, // ID is likely a string from Clerk/DB
      },
    });
...
export const deleteExam = async (currentState: CurrentSate, data: FormData) => {
  const id = data.get("id") as string;
